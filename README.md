...
|-------|------------------------------------------------|------------------------------------------------------------------------------------------------------------|
|1      |`Generative AI`, `Multimodal AI (Vision + Text)`, `Agentic AI Systems`, `LLM Prompt Engineering`, `Prompt Evaluation & Guardrails`, `Tool-Augmented Reasoning`, `LangChain`, `Google Gemini API`, `Neural Text-to-Speech (TTS)`, `Streamlit App Development & Deployment`, `Session State Management`, `API Integration`, `Error Handling & Rate-Limit Mitigation`, `System Design for GenAI Apps`, `Chatbot Architecture`, `Retrieval-Augmented Generation (RAG)`, `Vector Databases`, `Embeddings`, `Semantic Search`, `Python`
|<a href="https://github.com/SamyakJain-DS/AI-Systems-Showcase">AI Systems Showcase</a> |
